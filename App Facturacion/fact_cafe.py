...
# etiqueta titulo
etiqueta_titulo = Label(panel_superior, text='FACTURACIÓN - Café EspecialiTACC', fg='DarkOrange4',
                        font=('Bahnschrift', 40, 'bold'), bg='burlywood1', width=40)

etiqueta_titulo.grid(row=0, column=0)

# panel izquierdo
panel_izquierdo = Frame(aplicacion, bd=1, relief=FLAT, bg="burlywood")
panel_izquierdo.pack(side=LEFT,  padx=15)

# panel costos
panel_costos = Frame(panel_izquierdo, bd=1, relief=FLAT, bg='burlywood1', pady=7, padx=30)
panel_costos.pack(side=BOTTOM, fill='both')

# panel CAFES
panel_cafes = LabelFrame(panel_izquierdo, text='CAFETERÍA', font=('Dosis', 19, 'bold'),
                           bd=1, relief=FLAT, fg='DarkOrange4', pady=5)
panel_cafes.pack(side=LEFT, fill='both', padx=1)

# panel PANADERIAS
panel_panaderias = LabelFrame(panel_izquierdo, text='PANADERÍA', font=('Dosis', 19, 'bold'),
                           bd=1, relief=FLAT, fg='DarkOrange4', pady=5)
panel_panaderias.pack(side=LEFT, fill='both', padx=1)

# panel MENUES
panel_menues = LabelFrame(panel_izquierdo, text='MENÚS', font=('Dosis', 19, 'bold'),
                           bd=1, relief=FLAT, fg='DarkOrange4', pady=5)
panel_menues.pack(side=LEFT, fill='both', padx=1)

# panel derecha
panel_derecha = Frame(aplicacion, bd=1, relief=FLAT, bg='bisque')
...
panel_nombre = Label(panel_derecha, text="Nombre del cliente: ", pady=10, bg='bisque', font=('Dosis', 11, 'bold'))
panel_nombre.pack(side=LEFT)
Entry(panel_derecha, textvariable=nombre_cliente).pack(side=LEFT, pady=10)

panel_telefono = Label(panel_derecha, text="Telefono del cliente: ", pady=10, bg='bisque', font=('Dosis', 11, 'bold'))
